 ...
 * Pour fonctionner, le service a besoin de la clé privée présente dans le fichier .env.local
 * C'est pour ça que nous demandant à Symfony de nous fournir le service ParameterBagInterface qui nous permettra d'accéder aux paramètres globaux du site
 */
